...
import awsjssdk  from '@salesforce/resourceUrl/sdk';
...
export default class viewFile extends LightningElement {
    ...
    async showDocument() {
        ...
        AWS.config.update({
            accessKeyId: "AKIAUM4WCVWQ3ASGAC2H",
            secretAccessKey: "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",
            region_config: "ap-south-1"
        });
